...
public sealed class BurnTrackDraft
{
    ...
    public const int MaxLyricsLength = 1_000_000;
    ...
    public string UnsynchronizedLyrics { get; set; } = string.Empty;
    public string SynchronizedLyrics { get; set; } = string.Empty;
    ...
    internal bool LyricsChanged { get; set; }
